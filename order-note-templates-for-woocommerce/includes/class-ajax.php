...
class WC_ONT_Ajax {
    ...
    public function __construct() {
        add_action( 'wp_ajax_wc_ont_get_templates',  array( $this, 'get_templates' ) );
        add_action( 'wp_ajax_wc_ont_get_order_data', array( $this, 'get_order_data' ) );
    }
    ...
    public function get_templates() {
        ...
        $rows = $wpdb->get_results( "SELECT id, title, note_text, note_type FROM {$table} ORDER BY note_type, sort_order, title", ARRAY_A );
